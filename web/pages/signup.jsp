...
<ul>
    ...
    <li>
        <siscofeSt:label styleClass="desc" key="userForm.username"/>
    ...
    <li>
        <div>
            <div class="left">
                <siscofeSt:label styleClass="desc" key="userForm.password"/>
                <html:errors property="password"/>
                <html:password styleClass="text medium" property="password" styleId="password" redisplay="true"/>
            </div>
            <div>
                <siscofeSt:label styleClass="desc" key="userForm.confirmPassword"/>
    ...
    <li>
        <siscofeSt:label styleClass="desc" key="userForm.passwordHint"/>
    ...
    <li>
        <div>
            <div class="left">
                <siscofeSt:label styleClass="desc" key="userForm.firstName"/>
                <html:errors property="firstName"/>
                <html:text styleClass="text medium" property="firstName" styleId="firstName" maxlength="50"/>
            </div>
            <div>
                <siscofeSt:label styleClass="desc" key="userForm.lastName"/>
    ...
    <li>
        <div>
            <div class="left">
                <siscofeSt:label styleClass="desc" key="userForm.email"/>
                <html:errors property="email"/>
                <html:text styleClass="text medium" property="email" styleId="email"/>
            </div>
            <div>
                <siscofeSt:label styleClass="desc" key="userForm.phoneNumber"/>
    ...
    <li>
        <siscofeSt:label styleClass="desc" key="userForm.website"/>
    ...
    <li>
        ...
        <div class="group">
            ...
            <div>
                ...
                <p><siscofeSt:label key="userForm.addressForm.province"/></p>
            </div>
            <div class="left">
                ...
                <p><siscofeSt:label key="userForm.addressForm.postalCode"/></p>
            </div>
            <div>
                <siscofeSt:country name="countries" toScope="page"/>
                ...
                <p><siscofeSt:label key="userForm.addressForm.country"/></p>
            </div>
        </div>
    </li>
